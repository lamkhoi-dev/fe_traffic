    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <motion.div
          ...
          className="glass-card p-6 md:p-8 mb-6 relative md:static left-1/2 md:left-0 -translate-x-1/2 md:translate-x-0 w-screen md:w-full md:rounded-2xl rounded-none"
        >
          <div className="flex items-start space-x-4 mb-6 px-2 md:px-0">
          ...
          <div className="space-y-3 mb-6">
            ...
            <div className="p-3 bg-white/5 md:rounded-xl">
              ...
              {task?.step2Image && (
                <div 
                  ...
                  onClick={() => setZoomImage(task.step2Image)}
                >
                  <img 
                    src={task.step2Image} 
                    alt="Hướng dẫn bước 2" 
                    className="border-y-2 md:border-2 md:rounded-xl border-white/20 w-full h-auto shadow-lg shadow-black/30"
            ...
            <div className="p-3 bg-white/5 md:rounded-xl">
              ...
              {task?.step3Image && (
                <div 
                  className="mt-3 -mx-3 cursor-pointer" 
                  onClick={() => setZoomImage(task.step3Image)}
                >
                  <img 
                    src={task.step3Image} 
